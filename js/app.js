...
const app = {
  ...
  async handleLogin(e) {
    ...
    try {
      const data = await AuthAPI.login(form.username.value, form.password.value);
      AppState.user = data.user;
      AppState.serverStats = data.stats;
      this.hideAuthModal();
      this.renderUserArea();
  ...
  async handleRegister(e) {
    ...
    try {
      const data = await AuthAPI.register(form.username.value, form.password.value, form.nickname.value);
      AppState.user = data.user;
      this.hideAuthModal();
      this.renderUserArea();
      this.renderHome();
